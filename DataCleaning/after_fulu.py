...
for filename in files:
    # 构建文件的绝对路径
    file_path = os.path.join('C:/MyCoding/DBtext_inter', filename)
    after_file_path = os.path.join('C:/MyCoding/DBtext_another', f"{filename}")
    '''between_file_path = os.path.join('C:/MyCoding/GBtext_edit', f"{filename}")'''
    ...
    if after_text:
        with open(after_file_path, 'w', encoding='utf-8', errors='ignore') as new_file:
