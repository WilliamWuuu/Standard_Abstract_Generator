...
# 存放pdf文件的绝对路径
txt_path = '/Users/wyx/Desktop/Python_Files/data_op/GB_text'
# 存放txt文件的绝对路径
preface_path = '/Users/wyx/Desktop/Python_Files/data_op/GB_part/part'

# 遍历文件夹中的文件
for filename in os.listdir(txt_path):
    file_path = os.path.join(txt_path, filename)
    preface = part_extract(file_path, "规范性引用文件")   
